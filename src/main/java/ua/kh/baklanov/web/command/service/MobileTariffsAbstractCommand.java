...
public class MobileTariffsAbstractCommand implements AbstractCommand {
    private static final Logger LOG = Logger.getLogger(MobileTariffsAbstractCommand.class);
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            LOG.error(Messages.ERROR_TARIFF_DAO + MobileTariffsAbstractCommand.class.getName(), e);
