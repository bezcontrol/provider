...
public class AllTariffsAbstractCommand implements AbstractCommand {
    private static final Logger LOG = Logger.getLogger(AllTariffsAbstractCommand.class);
    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            LOG.error(Messages.ERROR_TARIFF_DAO + AllTariffsAbstractCommand.class.getName(), e);
